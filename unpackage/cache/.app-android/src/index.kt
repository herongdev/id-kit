...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    val hosts: String = "198.18.0.1,172.30.144.1,172.21.96.1,192.168.1.84,127.0.0.1"
    val port: String = "8090"
    val id: String = "app-android_U1tKdh"
    if (hosts == "" || port == "" || id == "") {
...
open class UniAppConfig : io.dcloud.uniapp.appframe.AppConfig {
    override var name: String = "id-kit-demo"
    override var appid: String = "__UNI__64E08CC"
